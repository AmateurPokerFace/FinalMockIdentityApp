...
namespace FinalMockIdentityXCountry.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [ValidateNever]
            public IEnumerable<SelectListItem> CurrentRolesList { get; set; }
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            {
                CurrentRolesList = _roleManager.Roles
                .Select(x => x.Name)
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (Input.Role == null)
                    {
                        await _userManager.AddToRoleAsync(user, StaticDetails.Role_Not_Assigned);
                    }
                    else
                    {
                ...
                {
                    ModelState.AddModelError(string.Empty, error.Description + $" Spaces are also not allowed.");
                }
            }
